-- ============================================================
--  FLUVË STUDIO — Schema SQL v2.0  [pgAdmin / PostgreSQL puro]
--  
--  DIFERENCIA con la versión Supabase:
--    · Se crea un schema auth stub para satisfacer la FK de users.
--    · En Supabase este stub NO debe ejecutarse (ya existe auth.users).
-- ============================================================

-- Stub de auth para entornos sin Supabase (pgAdmin, RDS, etc.)
